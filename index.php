        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <div class="md-form mb-5">
                    ...
                    <input placeholder="" name="day" type="text" id="date" class="form-control validate col-lg-2">
                ...
                <div class="md-form mb-3">
                    ...
                    <div class="form-group">
                    <label data-error="wrong" data-success="right" for="student">For:</label>
                    <input placeholder="1000" name="student" type="text" id="student" class="form-control validate col-lg-5">
                    </div>
                 </div>
                 </form>
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button id="appoint" class="btn btn-info">Submit <i class="fa fa-paper-plane-o ml-1"></i></button>
